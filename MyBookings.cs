...
namespace TixNova__Final
{
    public partial class MyBookings : Form
    {
        ...
        private void LoadUserBookings()
        {
            ...
            if (BookingData.AllBookings != null && BookingData.AllBookings.Count > 0)
            {
                foreach (var booking in BookingData.AllBookings)
                {
                    listPanel.Controls.Add(CreateBookingCard(booking));
                }
            }
            else
            {
                Label lblEmpty = new Label
                {
                    ...
                    Size = new Size(listPanel.Width - 40, 100)
                };
                listPanel.Controls.Add(lblEmpty);
            }
            glassContainer.Controls.Add(listPanel);
        }
        private Panel CreateBookingCard(BookingData data)
        {
            ...
            {
                Text = $"{data.Cinema} | {data.Schedule}",
